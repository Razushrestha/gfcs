        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <div className="text-2xl font-bold text-white">GFCS</div>
            </div>
            <p className="text-sm text-gray-400 mb-6 leading-relaxed">
              Empowering businesses through expert accounting, tax, and advisory solutions. Trusted by enterprises and SMEs across Nepal.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://www.facebook.com/gfcsnepal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <span><strong>Headquarter:</strong> Banasthali Chowk, Kathmandu</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span><strong>Phone (HQ):</strong> <a href="tel:+9779847761230" className="hover:text-white">+977 9847761230</a></span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span><strong>Phone (Branch):</strong> +977 9802360825</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span><strong>Email (HQ):</strong> <a href="mailto:info@gfcsnepal.com" className="hover:text-white">info@gfcsnepal.com</a></span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span><strong>Email (Branch):</strong> <a href="mailto:corporate@gfcsnepal.com" className="hover:text-white">corporate@gfcsnepal.com</a></span>
              </li>
              ...
              <li className="flex items-start">
                ...
                <span><strong>Subsidiary offices:</strong> Ilam, Gorkha, Dang, Chitwan, Surkhet</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span><strong>Careers:</strong> ramhari@gfcsnepal.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              © {currentYear} GFCS Consulting & Advisory. All rights reserved.
            </p>
